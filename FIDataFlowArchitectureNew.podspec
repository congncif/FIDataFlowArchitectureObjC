...
Pod::Spec.new do |s|
  s.name             = "FIDataFlowArchitectureObjC"
  s.version          = "1.5.2"
...
Easy to create a clear architecture application with FIDataFlowArchitectureNew. I think you will gradually love it.
  ...
  s.homepage         = "https://github.com/congncif/FIDataFlowArchitectureObjC"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = '[iF] Solution'
  s.author           = { "NGUYEN CHI CONG" => "congnc.if@gmail.com" }
  s.source           = { :git => "https://github.com/congncif/FIDataFlowArchitectureObjC.git", :tag => s.version.to_s }
